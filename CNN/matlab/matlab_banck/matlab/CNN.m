...
% 读取图片
image = imread('E:\spyder\project\project\test\4\33.png'); 
% 调整图片大小为 32x32
...
% conv1_bias = floor(conv1_bias * 256) ;
% 
% conv2_bias = floor(conv2_bias * 256) ;
% 
% fc1_bias = floor(fc1_bias * 256) ;
% 
% fc2_bias = floor(fc2_bias * 256) ;
% 
% fc3_bias = floor(fc3_bias * 256) ;
...
test_fc2_out_data = max(fc2_out_data);
